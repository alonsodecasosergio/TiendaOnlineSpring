...
public class PDFHeaderFooter extends PdfPageEventHelper {
    ...
    public void onStartPage(PdfWriter writer, Document document) {
    	...
    	try {
	    	...
	    	//imagen
    		//Obtenemos la imagen
    		imagen = Image.getInstance("./img/logo.jpg");
		    ...
		    */
	    	...
	    	ColumnText.showTextAligned(cb, Element.ALIGN_RIGHT, txtCabecera, (document.right() - document.left() + 30), document.top(), 0);
	    	
	    	
	    	txtCabecera = new Phrase(empresa);
	    	ColumnText.showTextAligned(cb, Element.ALIGN_LEFT, txtCabecera, (document.left() + 30), document.top() + 45, 0);
	    	
	    	txtCabecera = new Phrase(cif);
	    	ColumnText.showTextAligned(cb, Element.ALIGN_LEFT, txtCabecera, (document.left() +30), document.top() + 30, 0);
	    	
	    	txtCabecera = new Phrase(direccion);
	    	ColumnText.showTextAligned(cb, Element.ALIGN_LEFT, txtCabecera, (document.left() + 30), document.top() + 15, 0);
	    	
	    	txtCabecera = new Phrase(telefono);
	    	ColumnText.showTextAligned(cb, Element.ALIGN_LEFT, txtCabecera, (document.left() + 30), document.top() + 0, 0);
